...
// Based on go-paths-helper (GPL2 version) with minor modifications and improvements.
// See https://github.com/arduino/go-paths-helper for more details and documentation.
package paths
