			...
			f: &AppArmorProfileFile{
				...
				Profiles: []*Profile{{
					...
					Rules: Rules{
						...
						&File{Path: "/opt/intel/oneapi/compiler/*/linux/lib/*.so./*", Access: MustAccess(FILE, "r", "m")},
			...
			f: &AppArmorProfileFile{
				...
				Profiles: []*Profile{{
					...
					Rules: Rules{
						...
						&Capability{Names: []string{"dac_read_search"}},
						&File{Path: "@{exec_path}", Access: MustAccess(FILE, "m", "r")},
						&File{Path: "@{att}/profiles/", Access: MustAccess(FILE, "r")},
						&File{Path: "@{PROC}/@{pid}/attr/apparmor/current", Access: MustAccess(FILE, "r")},
						&File{Path: "@{PROC}/", Access: MustAccess(FILE, "r")},
						&File{Path: "@{sys}/module/apparmor/parameters/enabled", Access: MustAccess(FILE, "r")},
						&File{Path: "@{sys}/kernel/security/apparmor/profiles", Access: MustAccess(FILE, "r")},
						&File{Path: "@{PROC}/@{pid}/attr/current", Access: MustAccess(FILE, "r")},
						&Include{IsMagic: true, Path: "abstractions/consoles"},
						&File{Owner: true, Path: "@{PROC}/@{pid}/mounts", Access: MustAccess(FILE, "r")},
						&Include{IsMagic: true, Path: "abstractions/base"},
						&File{Path: "/dev/tty@{u8}", Access: MustAccess(FILE, "r", "w")},
						&Capability{Names: []string{"sys_ptrace"}},
						&Ptrace{Access: MustAccess(PTRACE, "read")},
					},
				}},
			},
